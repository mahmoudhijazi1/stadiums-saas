...
/**
 * Public header control. Sets cookie + html lang/dir (ar=rtl, en=ltr).
 */
export function PublicLangToggle({ locale }: { locale: UiLocale }) {
  ...
  return (
    <Button
      ...
      variant="outline"
      size="sm"
      aria-label={ui(next === "en" ? "public.langEnglish" : "public.langArabic", locale)}
      onClick={async () => {
